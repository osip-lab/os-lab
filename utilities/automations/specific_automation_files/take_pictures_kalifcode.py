...
callback_map = {'twenty ten': lambda: take_all_images(magnification=10, side=2422, locations_dict=locations_dict),
                ...
                'upper five': lambda: take_all_images(magnification=5, side='Upper', locations_dict=locations_dict),
                'upper ten': lambda: take_all_images(magnification=10, side='Upper', locations_dict=locations_dict),
                'upper twenty': lambda: take_all_images(magnification=20, side='Upper', locations_dict=locations_dict),
                'lower five': lambda: take_all_images(magnification=5, side='Lower', locations_dict=locations_dict),
                'lower ten': lambda: take_all_images(magnification=10, side='Lower', locations_dict=locations_dict),
                'lower twenty': lambda: take_all_images(magnification=20, side='Lower', locations_dict=locations_dict),
