...
class FitterWidget(ThreadedWidget):
    ...
    def __init__(self, font_size=14):
        ...
        self.switch = QCheckBox('continuous')
        self.switch.setChecked(False)
        self.switch.setToolTip('enable continuous measurement')
        ...
        layout = QMyVBoxLayout(self.switch, *(self.spinboxes[lbl] for lbl in self.labels))
